  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Project 3</h3>
          <p className="text-gray-600 mb-6">
            Image Warping and Mosaicing: Part A - Image Registration and Mosaicing
          </p>
          <Link 
            to="/cs280a/project3" 
            className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors"
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Project 4</h3>
          <p className="text-gray-600 mb-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Project 5</h3>
          <p className="text-gray-600 mb-6">
            The Power of Diffusion Models: Part A - Diffusion Models for Image Generation and Editing
          </p>
          <Link 
            to="/cs280a/project5" 
            className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors"
